...
namespace PDDL.PDDL12.Parsing
{
    ...
    internal static class ProblemGrammar
    {
        ...
        /// </summary>
        public static readonly Parser<IProblemRequireDefinition> RequirementsDefinition = CreateRequirementsDefinition();

        /// <summary>
        /// The initial state definition
        /// </summary>
        public static readonly Parser<IProblemInitialStateDefinition> InitDefinition = CreateInitDefinition();

        /// <summary>
        /// The objects definition
        /// </summary>
        public static readonly Parser<IProblemObjectsDefinition> ObjectsDefinition = CreateObjectDefinition();

        /// <summary>
        /// The goal definition
        /// </summary>
        public static readonly Parser<IProblemGoalDefinition> GoalDefinition = CreateGoalDefinition();

        /// <summary>
        /// The problem definition
        /// </summary>
        public static readonly Parser<IProblem> ProblemDefinition = CreateProblemDefinition();
