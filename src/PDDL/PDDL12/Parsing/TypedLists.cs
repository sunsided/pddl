...
namespace PDDL.PDDL12.Parsing
{
    ...
    internal static class TypedLists
    {
        ...
        /// </summary>
        public static readonly Parser<IEnumerable<CustomType>> TypedListOfType = CreateTypedListOfType();

        /// <summary>
        /// The typed list of name
        /// </summary>
        public static readonly Parser<IEnumerable<IObject>> TypedListOfObject = CreateTypedListOfObject();

        /// <summary>
        /// The typed list of variable
        /// </summary>
        public static readonly Parser<IEnumerable<IVariableDefinition>> TypedListOfVariable = CreateTypedListOfVariable();

        /// <summary>
        /// The typed list of constant
        /// </summary>
        public static readonly Parser<IEnumerable<IConstant>> TypedListOfConstant = CreateTypedListOfConstant();

        /// <summary>
        /// The typed list of domain variable
        /// </summary>
        public static readonly Parser<IEnumerable<IDomainVariable>> TypedListOfDomainVariable = CreateTypedListOfDomainVariable();
