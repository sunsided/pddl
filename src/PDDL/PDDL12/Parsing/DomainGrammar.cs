...
namespace PDDL.PDDL12.Parsing
{
    ...
    internal static class DomainGrammar
    {
        ...
        /// </summary>
        public static readonly Parser<IDomainPredicatesDefinition> PredicatesDefinition = CreatePredicatesDefinition();

        /// <summary>
        /// The extension definition
        /// </summary>
        public static readonly Parser<IDomainExtensionDefinition> ExtensionDefinition = CreateExtensionDefinition();

        /// <summary>
        /// The requirements definition
        /// </summary>
        public static readonly Parser<IDomainRequireDefinition> RequirementsDefinition = CreateRequirementsDefinition();

        /// <summary>
        /// The types definition
        /// </summary>
        public static readonly Parser<IDomainTypesDefinition> TypesDefinition = CreateTypesDefinition();

        /// <summary>
        /// The constants definition
        /// </summary>
        public static readonly Parser<IDomainConstantsDefinition> ConstantsDefinition = CreateConstantsDefinition();

        /// <summary>
        /// The timeless definition
        /// </summary>
        public static readonly Parser<IDomainTimelessDefinition> TimelessDefinition = CreateTimelessDefinition();

        /// <summary>
        /// The safety definition
        /// </summary>
        public static readonly Parser<IDomainSafetyDefinition> SafetyDefinition = CreateSafetyDefinition();

        /// <summary>
        /// The vars definition
        /// </summary>
        public static readonly Parser<IDomainVarsDefinition> VariablesDefinition = CreateVarsDefinition();

        /// <summary>
        /// The domain definition
        /// </summary>
        public static readonly Parser<IDomain> DomainDefinition = CreateDomainDefinition();
