...
namespace PDDL.Model.Pddl12
{
    ...
    public class Domain : IDomain
    {
        ...
        public IReadOnlyList<IAtomicFormula> Predicates { get; private set; }
        ...
        public Domain([NotNull] IName name, [NotNull] IReadOnlyList<IRequirement> requirements, [NotNull] IReadOnlyList<IType> types, [NotNull] IReadOnlyList<IVariable> constants, [NotNull] IReadOnlyList<IAtomicFormula> predicates, [NotNull] IReadOnlyList<ILiteral> timeless)
        {
